...
const payment = 300;
const check = alert(`Дякуємо, ${workerName}! До сплати ${payment} гривень`);
...
const scamOrNot = lowercaseSumbol1.includes('спам' || 'розпродаж');
console.log(scamOrNot)
const dangerAl = alert(`string1 має black listed word = ${scamOrNot}`)
...
const scamOrNot2 = lowercaseSumbol2.includes('розпродаж' || 'спам');
console.log(scamOrNot2)
const dangerAl2 = alert(`string2 має black listed word = ${scamOrNot2}`)

const string3 = 'Рекламна кампанія #jsIsAwesome';
const lowercaseSumbol3 = string3.toLowerCase();
console.log(lowercaseSumbol3)
const scamOrNot3 = lowercaseSumbol3.includes('спам' || 'розпродаж')
console.log(scamOrNot3)
const dangerAl3 = alert(`string3 має black listed word = ${scamOrNot3}`)